...
export function ResultsPage() {
  ...
  return (
    <Stack spacing={3}>
      <PageHeader
        description="وضعیت پردازش و اطلاعات شناسایی‌شدهٔ هر تصویر را بررسی کنید. پس از اتصال سرویس پردازش، نتایج در این بخش قرار می‌گیرند."
        eyebrow="داده‌های پردازش شده"
        title="نتایج تصاویر ارسال شده"
      />

      <Alert severity="info" variant="outlined">
        <Typography sx={{ paddingX: 1 }} variant="caption">
          در این نسخه ارتباطی با سرویس پردازش وجود ندارد؛ بنابراین تصاویر جدید
          در وضعیت «در انتظار پردازش» باقی می‌مانند.
        </Typography>
      </Alert>
      ...
      {library.data && library.data.images.length === 0 && (
        <EmptyState
          ...
          description="ابتدا یک مجموعه تصویر ذخیره کنید. هر تصویر و نتیجهٔ پردازش آن پس از ارسال در اینجا نمایش داده می‌شود."
